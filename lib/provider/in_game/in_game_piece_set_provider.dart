...
final class InGamePieceSet extends _$InGamePieceSet {
  ...
  void initPieceSet() {
    ...
    spawnPiece(BlackPawnEntity(x: 6, y: 1), PieceSpawnType.init);
    spawnPiece(BlackPawnEntity(x: 7, y: 1), PieceSpawnType.init);
  ...
  /// 기물 부활
  void spawnPiece(PieceBaseEntity pieceEntity, PieceSpawnType spawnType) {
    ...
    switch (spawnType) {
      case PieceSpawnType.init:
        break;
      case PieceSpawnType.spawn:
