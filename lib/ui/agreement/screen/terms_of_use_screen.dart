        ...
        child: Column(
          ...
          children: [
            const AgreementContents(
                contents:
                    'These terms and conditions apply to the Chess Defense app (hereby referred to as "Application") for mobile devices that was created by Kim Jin Pyo (hereby referred to as "Service Provider") as a Free service.'),
            ...
            const AgreementContents(
                contents:
                    'These terms and conditions are effective as of 2025-02-02'),
            const AgreementTitle(title: 'Contact Us'),
            const AgreementContents(
                contents:
                    'If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at kjp00552277@gmail.com.'),
            const AgreementContents(
                contents:
